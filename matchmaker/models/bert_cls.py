...
class Bert_cls(Model):
    ...
    def forward(self,  # type: ignore
        ...
        input_mask = (input_ids != 0).long() # can'T use tokens[maks] -> as this is for the offsets not used here
...
#       
    ...
    def forward_representation(self,  # type: ignore
        ...
        vectors, _ = self.bert_model(input_ids=input_ids,
                                    token_type_ids=token_type_ids,
                                    attention_mask=input_mask, output_all_encoded_layers=False)

        return vectors #[1:] # ignore cls token
